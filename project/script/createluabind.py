    ...
    if "lua_from" in a_Class["methods"]:
      for l_Name in a_Class["methods"]["lua_from"]:
        ...
        if a_Type == "singleton":
          ...
          a_Source.write("  }\n")
          a_Source.write("  else throw std::exception();\n")
        else:
        ...
        a_Source.write("  }\n")
        a_Source.write("  catch (std::exception &e) {\n")
        a_Source.write("    luaL_error(a_pState, (std::string(\"Function " + a_Name + ":" + l_Name + " failed: \\\"\")).c_str());\n")
        a_Source.write("  }\n")
    ...
    if "lua_to" in a_Class["methods"]:
      for l_Name in a_Class["methods"]["lua_to"]:
        ...
        if "comment" in l_Method:
          ...
          a_Source.write("      throw std::exception();\n")
          a_Source.write("    }\n")
...
def CreateBinding(a_Json):
  ...
  l_Source.write("#include <exception>\n")
