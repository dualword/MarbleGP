...
namespace dustbin {
  namespace scenenodes {
    ...
    * This scene node gives the player hints on
    * the path to take depending on the AI Help
    * Setting (not visible for "off" and "bot")
    */
    class CAiPathSceneNode : virtual public irr::scene::IBillboardSceneNode
    {
      public:
        CAiPathSceneNode(irr::scene::ISceneNode* parent, irr::scene::ISceneManager* mgr, irr::s32 id,
        ...
        */
        void setAiData(const irr::core::vector3df &a_cPoint1, const irr::core::vector3df &a_cPoint2);

      protected:
        void updateMesh(const irr::scene::ICameraSceneNode* camera, const irr::core::vector3df &a_cPointPos);

      private:
        irr::core::vector3df m_cPoint1;   /**< The first point caluclated by the AI */
        irr::core::vector3df m_cPoint2;   /**< The second point calculated by the AI */

        bool m_bFirstCall;    /**< Flag indicating the first "setAiData" call */
