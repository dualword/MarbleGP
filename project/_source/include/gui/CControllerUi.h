...
namespace dustbin {
  namespace gui {
    ...
    */
    class CControllerUi : public gui::CMenuBackground {
      private:
        ...
        irr::gui::IGUIElement *m_pSelectedOne,
                              *m_pSelectedTwo,
                              *m_pHoveredOne,
                              *m_pHoveredTwo;
        ...
        std::map<irr::gui::IGUIElement*, irr::gui::IGUIElement*> m_mTextPairs;

        std::map<irr::gui::IGUIElement*, std::vector<controller::CControllerBase::SCtrlInput>::iterator> m_mTextControls;
