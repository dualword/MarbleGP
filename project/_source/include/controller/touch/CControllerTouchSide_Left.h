...
namespace dustbin {
  namespace controller {
    ...
    */
    class CControllerTouchSide_Left : public CControllerTouchSide {
      protected:
        /**
      ...
      public:
        CControllerTouchSide_Left(irr::video::IVideoDriver *a_pDrv, const irr::core::recti &a_cViewport);
        virtual ~CControllerTouchSide_Left();
    };
  }
}
