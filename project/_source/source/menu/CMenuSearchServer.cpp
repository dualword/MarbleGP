  ...
  namespace menu {
    ...
    */
    class CMenuSearchServer : public IMenuHandler {
      ...
      public:
        CMenuSearchServer(irr::IrrlichtDevice* a_pDevice, IMenuManager* a_pManager, state::IState *a_pState) : IMenuHandler(a_pDevice, a_pManager, a_pState), m_pClient(nullptr) {
          m_pGui->clear();
