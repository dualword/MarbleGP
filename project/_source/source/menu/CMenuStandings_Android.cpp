    ...
    public:
      CMenuStandings(irr::IrrlichtDevice* a_pDevice, IMenuManager* a_pManager, state::IState *a_pState) : IMenuHandler(a_pDevice, a_pManager, a_pState) {
        ...
        if (l_pTab != nullptr) {
          ...
          irr::gui::IGUIStaticText *p = m_pGui->addStaticText(L"Pos", irr::core::recti(l_cColPos, irr::core::dimension2du(10 * l_iWidth / 100, l_iHeight)), true, true);
          ...
          l_cColPos.X += 10 * l_iWidth / 100;

          p = m_pGui->addStaticText(L"Name", irr::core::recti(l_cColPos, irr::core::dimension2du(29 * l_iWidth / 100, l_iHeight)), true, true);
          p->setTextAlignment(irr::gui::EGUIA_CENTER, irr::gui::EGUIA_CENTER);
          p->setDrawBackground(true);
          p->setBackgroundColor(irr::video::SColor(0xFF, 192, 192, 192));
          p->setOverrideFont(l_pRegular);
          l_cColPos.X += 29 * l_iWidth / 100;

          p = m_pGui->addStaticText(L"Points", irr::core::recti(l_cColPos, irr::core::dimension2du(15 * l_iWidth / 100, l_iHeight)), true, true);
          p->setTextAlignment(irr::gui::EGUIA_CENTER, irr::gui::EGUIA_CENTER);
          p->setDrawBackground(true);
          p->setBackgroundColor(irr::video::SColor(0xFF, 192, 192, 192));
          p->setOverrideFont(l_pRegular);
          ...
          p = m_pGui->addStaticText(L"D.N.F.", irr::core::recti(l_cColPos, irr::core::dimension2du(15 * l_iWidth / 100, l_iHeight)), true, true);
          p->setTextAlignment(irr::gui::EGUIA_CENTER, irr::gui::EGUIA_CENTER);
          p->setDrawBackground(true);
          p->setBackgroundColor(irr::video::SColor(0xFF, 192, 192, 192));
          p->setOverrideFont(l_pRegular);
          ...
          for (std::vector<data::SChampionshipPlayer>::iterator it = l_vStandings.begin(); it != l_vStandings.end(); it++) {
            ...
            p = m_pGui->addStaticText(std::to_wstring(l_iPos).c_str(), irr::core::recti(l_cColPos, irr::core::dimension2du(10 * l_iWidth / 100, l_iHeight)), true, true);
            p->setTextAlignment(irr::gui::EGUIA_CENTER, irr::gui::EGUIA_CENTER);
            ...
            irr::core::dimension2du l_cDim = irr::core::dimension2du(29 * l_iWidth / 100, l_iHeight);
            ...
            p = m_pGui->addStaticText((std::to_wstring((*it).m_iPoints) + L" ").c_str(), irr::core::recti(l_cColPos, irr::core::dimension2du(15 * l_iWidth / 100, l_iHeight)), true, true);
            ...
            p = m_pGui->addStaticText((std::to_wstring((*it).m_iStunned) + L" ").c_str(), irr::core::recti(l_cColPos, irr::core::dimension2du(15 * l_iWidth / 100, l_iHeight)), true, true);
            p->setTextAlignment(irr::gui::EGUIA_LOWERRIGHT, irr::gui::EGUIA_CENTER);
            p->setBackgroundColor(irr::video::SColor(128, 192, 192, 96));
            p->setDrawBackground(false);
            p->setOverrideFont(l_pRegular);
            ...
            p = m_pGui->addStaticText((std::to_wstring((*it).m_iRespawn) + L" ").c_str(), irr::core::recti(l_cColPos, irr::core::dimension2du(15 * l_iWidth / 100, l_iHeight)), true, true);
            p->setTextAlignment(irr::gui::EGUIA_LOWERRIGHT, irr::gui::EGUIA_CENTER);
            p->setBackgroundColor(irr::video::SColor(128, 192, 192, 96));
            p->setDrawBackground(false);
            p->setOverrideFont(l_pRegular);
            ...
            p = m_pGui->addStaticText((std::to_wstring((*it).m_iDidNotFinish) + L" ").c_str(), irr::core::recti(l_cColPos, irr::core::dimension2du(15 * l_iWidth / 100, l_iHeight)), true, true);
            p->setTextAlignment(irr::gui::EGUIA_LOWERRIGHT, irr::gui::EGUIA_CENTER);
            p->setBackgroundColor(irr::video::SColor(128, 192, 192, 96));
            p->setDrawBackground(false);
            p->setOverrideFont(l_pRegular);
