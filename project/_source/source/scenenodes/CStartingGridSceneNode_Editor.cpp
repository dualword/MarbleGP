  ...
  namespace scenenodes {
      ...
      m_fAngle(0.0f)
    {
      ...
      for (int i = 1; i <= 18; i++) {
        ...
        if (i == 0)
          m_cBox.reset(m_aVertices[0].Pos);
        else
      ...
      m_cBox.addInternalPoint(m_aVertices[18].Pos);
    ...
    void CStartingGridSceneNode_Editor::deserializeAttributes(irr::io::IAttributes* a_pIn, irr::io::SAttributeReadWriteOptions* a_pOptions) {
      ...
      m_fLength        = a_pIn->getAttributeAsFloat("Length");
