...
namespace dustbin {
  namespace messages {
    ...
    */
    ...
    std::string CSerializer64::getMessageAsString() {
      return m_sMessage.c_str();
    }

    bool CSerializer64::hasMoreMessages() {
      return m_iPos < m_aData.size();
    }
  }  // namespace dustbin
}    // namespace messages
